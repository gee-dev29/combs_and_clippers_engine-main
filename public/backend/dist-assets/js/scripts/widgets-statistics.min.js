...
$(document).ready(function () {
  ...
  var monthnums = JSON.parse(document.getElementById('monthnum').value);
  ...
  var sub_max_round = Math.round(Math.max(...subs)/10);
  
  var rev_monthnum = JSON.parse(document.getElementById('rev_monthnum').value);
  var revenue = JSON.parse(document.getElementById('revenue').value);
  var week_revenue = JSON.parse(document.getElementById('week_revenue').value);
  var week_day = JSON.parse(document.getElementById('week_day').value);
  var rev_max_round = Math.round(Math.max(...revenue)/1000);
  
  //var sub_max_round = Math.round(Math.max(subs)/1000);
  var months = months.map(element=>element.substring(0,3));
  var subs_r = subs.map(element=>element/10);
  var revenue_r = revenue.map(element=>element/1000);
