...
<div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    ...
                    <a type="button" class="btn btn-danger btn-xs pull-right" href="{{ route('report.download', ['type' => 'unsubscription']) }}" style="margin-right: 10px;">Download Report</a>
                ...
                <div class="row">
                           ...
                           <!--    <h4>Normal Well</h4> -->
                                        <table class="table">
                                          ...
                                          @if(count($reports) > 0)
                                            @foreach($reports as $unsub)
                                            <tr>
                                              <th scope="row">{{ $loop->iteration }}</th>
                                              <td>{{ $unsub->msisdn }}</td>
                                              <td>{{ $unsub->network_provider }}</td>
                                              <td>{{ $unsub->service_id }}</td>
                                              <td>{{ $unsub->product_id }}</td>
                                              <td>{{ $unsub->start_date }}</td>
                                              <td>{{ $unsub->end_date }}</td>
                                              <td>{{ $unsub->created_at }}</td>
