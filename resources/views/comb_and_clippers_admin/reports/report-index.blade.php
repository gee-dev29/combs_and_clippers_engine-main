...
<div>
    ...
    <select onchange="window.location.href = this.value;" class="form-control cnc:max-w-md">
        <option value="">Select a report</option>
        <option value="{{ route('admin.reports.general') }}">General Report</option>
        <option value="{{ route('admin.reports.appointments') }}">Appointment Report</option>
        <option value="{{ route('admin.reports.boothRentals') }}">BoothRental Report</option>
        <option value="{{ route('admin.reports.boothRentalPayments') }}">BoothRental Payment Report</option>
        <option value="{{ route('admin.reports.internalTransactions') }}">Internal Transaction Report</option>
        <option value="{{ route('admin.reports.bankDetails') }}">Bank Details Report</option>
        <option value="{{ route('admin.reports.walletTransactions') }}">Wallet Transaction Report</option>
        <option value="{{ route('admin.reports.wallets') }}">Wallet Report</option>
        <option value="{{ route('admin.reports.users') }}">User Report</option>
        <option value="{{ route('admin.reports.stores') }}">Store Report</option>
        <option value="{{ route('admin.reports.withdrawals') }}">Withdrawal Report</option>
    </select>
</div>
