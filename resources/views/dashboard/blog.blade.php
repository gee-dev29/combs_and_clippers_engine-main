                ...
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <a class="btn btn-primary pl-4 pr-4 mb-3" href="{{ route('blog.create') }}"><i
                                class="fa fa-plus" aria-hidden="true"></i> Create Blog</a>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0"
                                                        ...
                                                        colspan="1" style="width: 46px;"> SN </th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;"> Title</th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;"> Excerpt</th>
                                                        <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;">Full Description</th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;"> Category</th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;"> Status</th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;"> Date Created</th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="zero_configuration_table" rowspan="1"
                                                        colspan="1" style="width: 46px;"> Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php $limit = 100 @endphp
                                                @foreach ($data as $item)
                                                    <tr role="row">
                                                        <td>{{ $loop->iteration }}</td>
                                                        <td>{{ $item->title }}</td>
                                                        <td>{{ Str::limit($item->excerpt, $limit, '...')}}</td>
                                                        <td>{{ Str::limit($item->full_description, $limit, '...')}}</td>
