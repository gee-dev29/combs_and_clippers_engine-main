    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <h3>{{ is_null($pickupAddress) ? 'Add' : 'Edit' }} Pickup Address</h3>
                <div class="card mb-5">
                    <div class="card-body">
                        <form method="post" class="p-3" action="{{ route('pickupAddress.add') }}">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="street" class="form-control" id="street" type="text"
                                    ...
                                    value = "{{ is_null($pickupAddress) ? '' : removeLastPartAfterLastThreeCommas($pickupAddress->address) }}" />
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="city" class="form-control" id="city" type="text"
                                    ...
                                    value = "{{ is_null($pickupAddress) ? '' : $pickupAddress->city }}" />
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="state" class="form-control" id="state" type="text"
                                    placeholder="Ex: Kampala" required 
                                    value = "{{ is_null($pickupAddress) ? '' : $pickupAddress->state }}" />
                            </div>
                            <br>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary pl-3 pr-3">{{ is_null($pickupAddress) ? 'Add' : 'Update' }} Address</button>
                            </div>
