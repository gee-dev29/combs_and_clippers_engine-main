...
return [
    ...
    'products' => [
        ...
        'disbursement' => [
            ...
            // Refund
            'refund_uri' => env('MOMO_REFUND_TRANSACTION_URI', 'disbursement/v1_0/refund'),

            // Refund status
            'refund_status_uri' => env(
                'MOMO_DISBURSEMENT_REFUND_STATUS_URI',
                'disbursement/v1_0/refund/{referenceId}'
            ),
